...
class Details extends React.Component{
    ...
    componentDidMount (){
        ...
        axios({
            url: `https://floating-plains-66390/restaurantdetails/${restaurantId}`,
            method:"GET",
    ...
    handleOrder= () => {
        ...
        axios({
            url: `https://floating-plains-66390/menuItems/${restaurantId}`,
            method:"GET",
            Headers:{'Content-Type': 'application/json'}
         }).then(response =>{
    ...
    getData = (data) => {
        return fetch(`https://floating-plains-66390/payment`, {
            method: "POST",
            headers: {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button className="btn-order" onClick={this.handleOrder} >Order Now</button>
       ...
       style={customStyles}
        >
            ...
            <div className="model1">
                        <div className="glyphicon glyphicon-remove-circle" style={{ float: 'right', margin: '5px' }} onClick={() => this.handleCloseModal('itemsModalIsOpen', false)}></div>
                        <div className="model1">
            ...
            {/*<Modal isOpen={galleryModalIsOpen} style={customStylesGallery}>
                    
                    <div>
                        <i className='fa fa-close close-button' onClick={ ()=>this.handleCloseModal('galleryModalIsOpen', false)}/>
                    </div>
                
                <Carousel showThumbs={false} autoPlay={true}>
                    {restaurant && restaurant.thumbs && restaurant.thumbs.map((item) => {
                        return <div className='galleryCarouselImage'>
        ...
        <Modal isOpen={galleryModalIsOpen} 
               style={customStylesGallery}
               >
                    
                    <div>
                        <i className='glyphicon glyphicon-remove-circle'  onClick={ ()=>this.handleCloseModal('galleryModalIsOpen', false)}/>
                    </div>
            ...
            <Modal
                ...
                >
                    <div>
                    <div className="glyphicon glyphicon-remove-circle" style={{ float: 'right', margin: '5px' }} onClick={() => this.handleCloseModal('userDetailsModalIsOpen', false)}></div>
                   <div>
